...
const CustomButton = ({ onPress, title, bgVariant = "primary", textVariant = "default", IconLeft, IconRight, className, ...props }: ButtonProps) => {
    ...
    return (
        <TouchableOpacity onPress={onPress} className={`w-full p-3 mb-10 rounded-full flex flex-row justify-center items-center shadow-md shadow-neutral-400 ${getBgVariantStyle(bgVariant)} ${className}`} {...props}>
            {IconLeft && <IconLeft />}
